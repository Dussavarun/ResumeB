...
import { Save, ArrowLeft, FileText, Moon, Sun, Download ,ChevronRight} from "lucide-react";
    ...
    >
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={`group flex items-center gap-1.5 px-2.5 sm:px-4 py-2 rounded-lg sm:rounded-xl font-medium transition-all duration-300 hover:scale-105 active:scale-95 text-sm ${
                  isDark
              ...
              <div
                className={`flex items-center gap-1.5 sm:gap-2.5 px-2.5 sm:px-4 py-2 rounded-lg sm:rounded-xl transition-all duration-300 ${
                  isDark
            ...
            <div className="flex items-center gap-1.5 sm:gap-3">
              <button
                onClick={toggleTheme}
                className={`p-2 rounded-lg sm:rounded-xl transition-all duration-300 hover:scale-105 active:scale-95 ${
                  isDark
      ...
      <div className="flex flex-col lg:flex-row min-h-[calc(100vh-73px)]">
        ...
        >
          ...
          <div
  className={`relative sticky top-[57px] sm:top-[73px] z-40 transition-all duration-500 ${
    isDark
...
>
            ...
            <div className="overflow-x-auto scrollbar-hide">
              <div className="flex px-3 sm:px-6 py-2 sm:py-3 min-w-max">
                <div className="relative flex items-center gap-4 sm:gap-8 mx-auto">
                  {/* Animated underline */}
                  <span
                  ...
                  {sections.map((s) => (
                    <button
                      ...
                      className={`relative pb-2 text-sm sm:text-lg font-semibold transition-colors whitespace-nowrap ${
                        activeSection === s.id
                          ? isDark
                            ? "text-white"
                            : "text-black"
  ...
  <ChevronRight size={16} />
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="p-3 sm:p-6 lg:p-8">
              <div
                className={`max-w-3xl mx-auto rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 transition-all duration-500 ${
                  isDark
        ...
        >
          <div className="p-4 sm:p-6 lg:p-12">
            ...
            <div className="mb-6 sm:mb-8">
              ...
              <p
                className={`text-xs sm:text-sm ml-4 sm:ml-6 transition-colors duration-300 ${
